from PySide2.QtWidgets import QWidget, QVBoxLayout, QLineEdit, QPushButton, QHBoxLayout, \
    QFileDialog, QGroupBox, QSpinBox, QLabel, QComboBox
...
class AttributesPanel(QWidget):
    ...
    def __init__(self):
        ...
        # image attributes
        image_format_box = QGroupBox("Image Format")
        image_format_layout = QHBoxLayout(image_format_box)
        ...
        image_format_layout.addWidget(resolution_lbl)
        image_format_layout.addWidget(self.resolution_field)
        ...
        save_bttn.clicked.connect(self.save_frame.emit)
